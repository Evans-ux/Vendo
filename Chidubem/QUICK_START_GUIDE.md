...
4. Fill in:
   ...
   - **Type:** `HTTP Request`
   - **Method:** `POST`
   - **URL:** `https://vendo.com.ng/api/webhooks/supabase`
   - **HTTP Headers:**
     ```
...
1. Go to: `https://vendo.com.ng/auth/signup`
2. Fill in:
...
**Then access admin:**
1. Go to: `https://vendo.com.ng/admin/dashboard`
2. You should see the admin dashboard

### Test 4: Admin Actions

**Verify KYC:**
1. Go to: `https://vendo.com.ng/admin/kyc`
2. You should see the test supplier
3. Click on them to view documents
4. Click **Approve KYC**

**Approve Products:**
1. Go to: `https://vendo.com.ng/admin/products`
2. You should see pending products
3. Click **Approve** on a product

**Manage Suppliers:**
1. Go to: `https://vendo.com.ng/admin/suppliers`
