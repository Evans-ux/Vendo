...
export default function ChatDemo() {
  return (
    <section className="py-24 bg-brand-charcoal px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-brand-cream mt-3 mb-4">Watch Vee AI in action</h2>
          <p className="text-brand-cream/50 text-lg max-w-xl mx-auto">Real conversations happening right now on Telegram and WhatsApp.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-brand-cream font-semibold">Telegram</span>
              <span className="ml-auto text-xs text-brand-cream/30 bg-white/5 px-2 py-0.5 rounded-full">Live simulation</span>
            </div>
            <div className="h-[500px] rounded-2xl overflow-hidden shadow-2xl shadow-black/50 border border-white/5">
              <TelegramChat />
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15 }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-brand-cream font-semibold">WhatsApp</span>
              <span className="ml-auto text-xs text-brand-cream/30 bg-white/5 px-2 py-0.5 rounded-full">Live simulation</span>
            </div>
            <div className="h-[500px] rounded-2xl overflow-hidden shadow-2xl shadow-black/50 border border-white/5">
              <WhatsAppChat />
